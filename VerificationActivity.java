...
public class VerificationActivity extends AppCompatActivity implements
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(OTPRegistration.INTENT_PHONENUMBER);
            String countryCode = intent.getStringExtra(OTPRegistration.INTENT_COUNTRY_CODE);
